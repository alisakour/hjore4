          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()async{
                    final url = 'mailto:Hjorejobs@gmail.com';
                    if (await canLaunch(url)) {
                      await launch(url);
                    } else {
                      throw 'Could not launch $url';
            ...
            Wrap(
              ...
              children: [
                GestureDetector (
                  onTap: () async {
                    final url = 'https://www.facebook.com/Wazayfhndasiahmohndseenjodod?mibextid=ZbWKwL';
                    if (await canLaunch(url)) {
                    await launch(url);
                    } else {
                    throw 'Could not launch $url';
